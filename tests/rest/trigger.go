...
// https://redhatinsights.github.io/insights-operator-controller/packages/tests/rest/trigger.html
...
// checkGetTriggersForCluster0 tries to read list of triggers for cluster #0,
...
// checkGetTriggersForCluster1 tries to read list of triggers for cluster #1,
// check the response and compare list if expected values
