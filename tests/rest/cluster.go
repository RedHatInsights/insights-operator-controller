...
// https://redhatinsights.github.io/insights-operator-controller/packages/tests/rest/cluster.html
...
func createCluster(f *frisby.Frisby, clusterID, clusterName string) {
