...
insert into operator_configuration (id, cluster, configuration, changed_at, changed_by, active, reason) values (1, 0, 1, '2019-01-01', 'tester', 1, 'no reason');
...
insert into operator_configuration (id, cluster, configuration, changed_at, changed_by, active, reason) values (3, 2, 2, '2019-10-11', 'tester', 0, 'disabled one');
